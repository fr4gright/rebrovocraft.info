<html>
    <head>
        ...
        <link rel="stylesheet" href="/styles/commands-style.css">
                ...
                <div class="vote-elements">
                    ...
                    <table class="voters-table" style="width:100%">
                        <tr>
                          ...
                          <th style="color: aqua;">Voter</th>
                          <th style="color: #03fc07;">VIP</th>
                          <th style="color: #03fc07;">VIP<span style="color: red;">+</span></th>
                        </tr>
                        <tr>
                          <td>Prefix</td>
                          <td>✔</td>
                        ...
                        <tr>
                          <td>Residence Portals</td>
                          <td>✔</td>
                          <td>✔</td>
                          <td>✔</td>
                        </tr>
                        <tr>
                          <td>/skins gui, set, clear, update</td>
                          <td>✔</td>
                          <td>✔</td>
                          <td>✔</td>
                        </tr>
