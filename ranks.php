...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/styles/ranks-style.css">
                    ...
                    <div class="smaller-header">
                        <div class="server-name">
                            ...
                            <ul class="navs">
                                ...
                                <a href="ranks.php"><li class="current">RANKS</li></a>
                ...
                <div class="website-elements">
                    ...
                    <div class="ranks-container">
                        ...
                        <div class="ranks">
                            ...
                            <div class="rank">
                                <img src="/pictures/voter.png" alt="voter.png" width="79%">
                                <div class="buttons">
                                    <button onclick="comingSoon()">READ MORE</button>
                                </div>
                            </div>

                            <div class="rank">
                                <img src="/pictures/vip.png" alt="vip.png" width="80%">
                                <div class="buttons">
                                    <button onclick="comingSoon()">READ MORE</button>
                                    <button onclick="comingSoon()">BUY</button>
                                </div>
                            </div>

                            <div class="rank">
                                <img src="/pictures/vip-plus.png" alt="vip.png" width="80%">
                                <div class="buttons">
                                    <button onclick="comingSoon()">READ MORE</button>
                                    <button onclick="comingSoon()">BUY</button>
                                </div>
